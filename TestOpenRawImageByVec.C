//
// TestOpenRawImageByVec.C  (by Katsumasa Ikematsu)
//
//   main implementation is derived from an example code at http://www.sciement.com/
//
// Usage:
//   $ root -l 'TestOpenRawImageByVec.C("raw/Earth16bit.raw", 16, 16, 20)'
//   $ root -l 'TestOpenRawImageByVec.C+("raw/test2_obj0.raw", 2560, 2160, 0.25)'
//
#include <iostream>
#include <fstream>
#include <vector>
...
int TestOpenRawImageByVec(const string filepath, const int xsize, const int ysize, const double magnifi)
{
