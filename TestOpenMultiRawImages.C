//
// TestOpenMultiRawImages.C  (by Katsumasa Ikematsu)
//
// Usage:
//   $ root -l 'TestOpenMultiRawImages.C("raw/iconlist.txt", 16, 16, 20)'
//   $ root -l 'TestOpenMultiRawImages.C+("raw/test2list.txt", 2560, 2160, 0.1)'
//
#include <iostream>
#include <fstream>
#include <vector>
...
int TestOpenMultiRawImages(const string filelist, const int xsize, const int ysize, const double magnifi)
{
